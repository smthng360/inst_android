...
from src import BasicData, RegistrationData
import requests
import json
...
def get_email_click_body(data: RegistrationData) -> dict:
    reg_info = (
        {
            "first_name": None,
            "last_name": None,
...
def get_email_click_headers(data: RegistrationData) -> dict:
    return {
        "Host": "b.i.instagram.com",
        "Accept-Language": "en-US",
        "Content-Type": "application/x-www-form-urlencoded",
